...
import { ChevronRight, Stethoscope, Activity, Eye, User, Heart, Baby, Search, Send, MessageCircle } from 'lucide-react'
  ...
  return (
    <section id="procedimientos" className="py-24 bg-surface/80 backdrop-blur-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto mb-12 relative" onKeyDown={handleKeyDown}>
              ...
              >
                <Card className="p-6 h-full hover:border-secondary/40 transition-all group cursor-default">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-sm text-secondary font-medium hover:text-secondary/70 transition-colors"
                  >
                    {t('procedures.cta')}
